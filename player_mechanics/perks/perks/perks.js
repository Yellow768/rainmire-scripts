...
var p_early_bird = { id: "early_bird", type: 1, name: "Early Bird", cost: 6, description: "During the night, you conserve energy and suffer a -1 to all stats, but gain a +1 during the day" }
var p_night_owl = { id: "night_owl", type: 1, name: "Night Owl", cost: 6, description: "During the day, you conserve energy and suffer a -1 to all stats, but gain a +1 during the night" }
...
var p_revenge_attack = { id: "revenge_attack", type: 0, name: "Backsplash", cost: 0, description: "When active, one hydration is used every time you take damage. Once deactivated, the total amount of hydration used is added to your next attack's damage" }
...
var p_lifesteal = { id: "lifesteal", type: 0, name: "Blood Siphon", cost: 2, description: "While active, your attack damage is halved. You restore the other half amount as health, and use up hydration at the same rate." }
...
var d_dilution = { id: "dilution", cost: 4, name: "Dilution", description: "Items can only have 2 jelly strikes." }
...
var all_bad_perks = [d_extra_fall_damage, d_bow_malfunction, d_social_anxiety, d_winded,
    d_pescetarian, d_reckless, d_sloth, d_glass_frame, d_bouncy, d_hydrophobic, d_ugly_mug, d_vegetarian, d_dilution, d_cannibal, d_water_weight, d_weighed_down, d_uninspiring]
...
function init(e) {
    ...
    all_good_perks = [p_ripple_effect, p_repair, p_lifesteal, p_night_owl, p_early_bird, p_birthday_armor, p_flood_lockpick, p_conservationist, p_broken_rage, p_revenge_attack, p_invisibility, p_icicle, p_groundPound, p_dash, p_levitate, p_resurface, p_low_health_damage, p_barter, p_summon, p_companion_buff, p_hurricane, p_blood_cost, p_animal_lover, p_oxygenate, p_electric_eel]
...
function executePerk(e, index) {
    ...
    switch (selected_perk_array[index].id) {
        ...
        case "revenge_attack":
            ...
            title(e, "Collecting Backsplash", 'blue')
        ...
        case "lifesteal":
            switch (e.player.hasTag("lifesteal")) {
                case true:
                    ...
                    title(e, "Attacks returned to normal", 'red')
                    break;
                case false:
                    e.player.addTag("lifesteal")
                    title(e, "Siphon their blood!", 'red')
                    break;
            }
            break;
        case "ripple_effect":
