var good_perks = {
    ...
    encouragement: { id: "encouragement", type: 0, name: "Encouragement!", cost: 12, description: "Scraaaeam out a battle cry and rally your friends! Give your companions a health boost. The cost is lowered depending on your Heart Skills." },
    ...
    flood_lockpick: { id: "flood_lockpick", type: 0, name: "Flood Lockpick", cost: 2, description: "Activate, and then interact with a locked object to pick the lock. The percentage picked is based on the sum of Deftness, Knowledge, and Logic" },
