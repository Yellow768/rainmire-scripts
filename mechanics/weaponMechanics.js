...
function canSeePlayer(e) {
    ...
    /**/
    var coneangle = 420; /*angle of cone of sight in degrees, change this for your needs*/
    /**/
...
function damagedEntity(e) {
    ...
    if (Math.random() < getScore("Aptitude") / critAptitudeDivider) {
        ...
        executeCommand("/playsound iob:ui.crit player " + e.player.name + " " + e.player.x + " " + player.y + " " + e.player.z)
