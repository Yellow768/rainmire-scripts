...
var perk1_id,perk2_id,perk3_id,npc, setterGUI, type, perk1_owners,perk2_owners,perk3_owners
...
function perk_init(e) {
    ...
    if (!e.npc.storeddata.has("perk1_owners")) {
        e.npc.storeddata.put("perk1_owners", "[]")
        e.npc.storeddata.put("perk2_owners", "[]")
        e.npc.storeddata.put("perk3_owners", "[]")
    }
    ...
    perk1_owners = JSON.parse(e.npc.storeddata.get("perk1_owners"))
    perk2_owners = JSON.parse(e.npc.storeddata.get("perk2_owners"))
    perk3_owners = JSON.parse(e.npc.storeddata.get("perk3_owners"))
