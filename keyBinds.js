...
function showKeybindGUI(e) {
    ...
    KEYBIND_GUI.addButton(id(keyBindsKeys[5]), GLFWKeys[keyBinds.key_reload], horizontalPos, verticalPos + 180, horizontalSize, verticalSize)
    ...
    KEYBIND_GUI.addLabel(id("L_Reload"), "Reload Scripts:", horizontalPos - 80, verticalPos + 190, 1, 1)
