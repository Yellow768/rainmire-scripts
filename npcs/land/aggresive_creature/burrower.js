...
function target(e) {
    ...
    e.npc.timers.start(1, getRandomInt(40, 120), false)
}
...
function beginBurrow() {
    if (npc.inWater()) {
        npc.timers.start(1, getRandomInt(40, 120), false)
        return
    }
    ...
    npc.timers.forceStart(2, 50, false)
...
function timer(e) {
    ...
    if (e.id == 2) {
        ...
        spawnCircularParticles(e.npc.world, "crit", 2, 0, 0, e.npc.x, e.npc.y, e.npc.z)
